...
<html lang="en">
  ...
  <body>
    ...
    <?php  include 'partials/_headerfeedbackpage.php'; ?>
    ...
    <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="img/fb1.jpg" class="d-block w-100" alt="..." width="200" height="600">
          <div class="carousel-caption d-none d-md-block text-primary">
            <br >
            <h1 align="right"><i>Your FeedBack Matters....!</i></h1>
            <h4 align="right">Add your details and suggestions for particular college that are definitely helpful for students.</h4>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container my-6">
            ...
            <form class="row g-3" action="feedback.php" method="post">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="batch" name="batch" placeholder="Enter a Batch Year(FROM-TO)"
                        required>
                </div>
                <div class="col-12">
...
<div class="col-12" align="right">
  <a class="navbar-brand" href="index.php">
    <button class="btn btn-outline-danger col-2">Back To Home</button>
  </a>
</div>
